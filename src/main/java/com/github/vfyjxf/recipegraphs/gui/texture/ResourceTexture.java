...
import com.github.vfyjxf.recipegraphs.api.gui.texture.IGuiTextureStatic;
 ...
 */
public class ResourceTexture implements IGuiTextureStatic {

    private final GraphTextureManager graphTextureManager;
    ...
    public ResourceTexture(GraphTextureManager graphTextureManager, ResourceLocation location, int width, int height) {
        this.graphTextureManager = graphTextureManager;
    ...
    public void draw(PoseStack poseStack, int xOffset, int yOffset, int maskTop, int maskBottom, int maskLeft, int maskRight) {
        TextureAtlasSprite sprite = graphTextureManager.getSprite(location);

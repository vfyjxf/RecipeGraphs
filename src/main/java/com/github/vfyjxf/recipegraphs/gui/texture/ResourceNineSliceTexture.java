...
public class ResourceNineSliceTexture {
    ...
    public ResourceNineSliceTexture(GraphTextureManager graphTextureManager, ResourceLocation location, int width, int height, int left, int right, int top, int bottom) {
